...
_ZH_CN: dict[str, str] = {
    ...
    "Use Full Workspace": "使用完整工作区",
    "Start creating": "开始创作",
    "Choose what you want to make. PySTG will create a runnable starting point.": "选择你想制作的内容，PySTG 会先创建一个可以运行的起点。",
    "Make a Pattern": "做一个弹幕",
    "Start from a preset, adjust a few values, then preview it.": "从预设开始，调整几个参数，然后立即预览。",
    "Make a Midstage": "做一段道中",
    "Begin with two editable waves and an all-clear continuation.": "从两波可编辑内容和敌人全灭后继续开始。",
    "Make a Boss Battle": "做一个 Boss 战",
    "Begin with an entrance and two editable Boss phases.": "从登场和两个可编辑的 Boss 阶段开始。",
    "Open Existing Work": "打开已有作品",
    "Open Example": "查看示例",
    "First Pattern": "第一个弹幕",
    "Aimed Fan": "自机狙扇形",
    "Short Midstage": "短道中",
    "Two-phase Boss Example": "两阶段 Boss 示例",
    "You can switch to the full workspace at any time without changing your work.": "你可以随时切换到完整工作区，当前作品不会改变。",
    "Beginner Guide": "创作引导",
    "Boss Workflow": "Boss 创作流程",
    "Midstage Workflow": "道中创作流程",
    "Scene Workflow": "场景创作流程",
    "Choose a phase, edit its timeline, then preview your work.": "选择一个阶段，编辑它的时间线，然后预览作品。",
    "Choose a phase to continue.": "选择一个阶段以继续。",
    "Adjust the enemy movement, main Pattern, and what happens after all enemies are defeated.": "调整敌人移动、主要弹幕，以及敌人全灭后发生的事情。",
    "Adjust this phase's movement, Pattern, background, and completion rule.": "调整这个阶段的移动、弹幕、背景和完成规则。",
    "Arrange this phase on the timeline, then preview it.": "在时间线上编排这个阶段，然后进行预览。",
    "Edit This Phase Timeline": "编辑这个阶段的时间线",
    "Preview This Work": "预览当前作品",
    "Back to Start": "返回开始页",
    "Quick Start": "快速开始",
    "Advanced Nodes": "高级节点",
    "Use This Preset": "使用这个预设",
    "Choose a starting Pattern": "选择一个起点弹幕",
    "Pick an effect that is close to what you want. You can change every important value next.": "选择一个接近目标的效果，下一步可以调整所有重要参数。",
    "Show Preset Internals": "查看预设内部详情",
    "Saved": "已保存",
    "Not saved yet": "尚未保存",
    "Unsaved changes": "有未保存的更改",
    "Current work · not saved yet": "当前作品 · 尚未保存",
    "Preview unavailable: add something to the timeline first.": "无法预览：请先在时间线上添加内容。",
    "State Flow": "关卡流程",
    "Variables": "变量",
