...
# ``src.editor.graphics.pattern_canvas`` layer in ER6.0 to break the historical
# ``pattern_workspace`` <-> ``graph_workspace`` import cycle.  They are
# re-exported at the top of this module so the public surface is unchanged.
